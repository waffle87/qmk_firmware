...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_split_3x5_3(
    ...
    CTLESC, KC_TAB, KC_CAPS, KC_TILD, KC_GRV,        KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_RCTL,
                        KC_LGUI, KC_TRNS, KC_SPC, KC_BSPC, KC_VOLU, CLIPST
  ),
  [_RAISE] = LAYOUT_split_3x5_3(
    QMKTD,   DOCSTD,  ROFL,    KC_TRNS, KC_BSLS,      KC_MPRV, KC_MPLY, KC_MNXT, KC_TRNS, KC_DEL,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PIPE,      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,        KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,
                          KC_LGUI, KC_VOLD, KC_SPC, KC_BSPC, KC_TRNS, CLIPST
  )
};
