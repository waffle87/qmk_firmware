...
static const pin_t row_pins[MATRIX_COLS] = MATRIX_COL_PINS;
static const pin_t col_pins[MATRIX_ROWS] = MATRIX_ROW_PINS;
...
bool matrix_scan_custom(matrix_row_t current_matrix[]) {
  matrix_row_t raw_matrix[MATRIX_COLS];
  for (size_t row_idx = 0; row_idx < MATRIX_COLS; row_idx++) {
